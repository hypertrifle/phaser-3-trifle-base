...
export class ControlSystem {
  ...
  controlPrompt: Phaser.GameObjects.Image;
  ...
  constructor(scene: Phaser.Scene) {
    ...
    this.classicSteer = this.owner.add.rectangle((this.owner.dimensions.x / 4) * 3, (this.owner.dimensions.y / 4) * 3, this.owner.dimensions.x / 2, this.owner.dimensions.y / 2, 0xFFAA00, 0);
        ...
        this.classicA = this.owner.add.rectangle((this.owner.dimensions.x / 8) * 1, (this.owner.dimensions.y / 8) * 7, (this.owner.dimensions.x / 8) * 2, (this.owner.dimensions.y / 8) * 2, 0x00FFAA, 0);
        ...
        this.classicB = this.owner.add.rectangle((this.owner.dimensions.x / 16) * 3, (this.owner.dimensions.y / 8) * 5, (this.owner.dimensions.x / 8) * 2, (this.owner.dimensions.y / 8) * 2, 0xff00AA, 0);
        ...
        this.owner.add.image(480, 310,"atlas.png", "steer-overlay-smaller.png");
        this.owner.add.image(81, 315,"atlas.png", "accelerate-overlay-smaller.png");
        this.owner.add.image(120, 226,"atlas.png", "brake-overlay-smaller.png");
      }
  ...
  addPromt() {
    if (this.owner.game.device.os.desktop) {
      this.controlPrompt = this.owner.add.image(this.owner.dimensions.x / 2, this.owner.dimensions.y / 2, "atlas.png", "instructions/instructionsDesktop.png");
      this.controlPrompt.setInteractive();
      this.controlPrompt.on("pointerup", function(){
        this.controlPrompt.setVisible(false);
      }, this);
    }
  }
